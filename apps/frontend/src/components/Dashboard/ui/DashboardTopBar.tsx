...
const DashboardTopBar: React.FC<DashboardTopBarProps> = ({
  ...
  const { goBack, goForward, canGoBack, canGoForward } = useDashboardNavigation();
      ...
      <div className="dashboard-top-bar__left">
        {showNavigation && (
          <div className="dashboard-top-bar__nav-buttons">
            <button
              className={cls('dashboard-top-bar__nav-button', {
      ...
      <div className="dashboard-top-bar__right">
        ...
        {showViewModes && (
          <div className="dashboard-top-bar__view-buttons">
            <button
              className={cls('dashboard-top-bar__view-button', {
                'dashboard-top-bar__view-button--active': state.activeViewMode === 'grid'
              }, undefined)}
            ...
            <button
              className={cls('dashboard-top-bar__view-button', {
                'dashboard-top-bar__view-button--active': state.activeViewMode === 'list'
              }, undefined)}
            ...
            <button
              className={cls('dashboard-top-bar__view-button', {
                'dashboard-top-bar__view-button--active': state.activeViewMode === 'table'
              }, undefined)}
        ...
        {showFilters && (
          <>
            <button
              className={cls('dashboard-top-bar__filter-button', {
                'dashboard-top-bar__filter-button--active': state.isFiltersOpen || !!state.activeFilter
              }, undefined)}
            ...
            {state.isFiltersOpen && (
              ...
              >
                <button
                  className={cls('dashboard-top-bar__filter-option', {
                    'dashboard-top-bar__filter-option--active': state.activeFilter === 'category'
                  }, undefined)}
                ...
                <button
                  className={cls('dashboard-top-bar__filter-option', {
                    'dashboard-top-bar__filter-option--active': state.activeFilter === 'type'
                  }, undefined)}
                ...
                <button
                  className={cls('dashboard-top-bar__filter-option', {
                    'dashboard-top-bar__filter-option--active': state.activeFilter === 'date'
                  }, undefined)}
                ...
                <button
                  className={cls('dashboard-top-bar__filter-option', {
                    'dashboard-top-bar__filter-option--active': state.activeFilter === 'tag'
                  }, undefined)}
