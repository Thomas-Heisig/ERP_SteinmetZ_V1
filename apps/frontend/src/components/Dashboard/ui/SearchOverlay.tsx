      ...
      >
        ...
        <div className="search-overlay__result-content">
          <div className="search-overlay__result-header">
            <h3 className="search-overlay__result-title">{result.title}</h3>
      ...
      switch (e.key) {
        ...
        case "Enter":
          ...
          if (
            ...
            state.selectedIndex < displayResults.length
          ) {
