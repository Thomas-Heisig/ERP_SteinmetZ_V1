  ...
  return (
    <header className="node-details__header">
      ...
      <div className="node-details__title-section">
        <div className="node-details__icon" style={{ color: categoryColor.primary }}>
      ...
      <div className="node-details__actions">
        {onEdit && (
          <button
            className={cls('node-details__action-button', {
          ...
          >
            ...
            <span>{isEditing ? t('nodeDetails.cancelEdit') : t('nodeDetails.edit')}</span>
          </button>
        )}
...
const NodeProperties: React.FC<NodePropertiesProps> = ({ node }) => {
  ...
  const properties = [
    ...
    { label: t('nodeDetails.properties.type'), value: getNodeTypeLabel(node.type) },
    { label: t('nodeDetails.properties.category'), value: node.category },
    { label: t('nodeDetails.properties.created'), value: formatDate(node.createdAt) },
    { label: t('nodeDetails.properties.updated'), value: formatDate(node.updatedAt) },
      ...
      <div className="node-details__properties-grid">
        {properties.map((prop, index) => (
          <div key={index} className="node-details__property">
            ...
            <span className="node-details__property-value">{prop.value || '-'}</span>
          </div>
        ))}
      </div>
  ...
  return (
    <div className={nodeDetailsClasses}>
      ...
      <nav className="node-details__tabs">
        <button
          className={cls('node-details__tab', {
        ...
        <button
          className={cls('node-details__tab', {
            'node-details__tab--active': localState.activeTab === 'properties'
          }, undefined)}
        ...
        <button
          className={cls('node-details__tab', {
            'node-details__tab--active': localState.activeTab === 'relationships'
          }, undefined)}
