...
export const nodeIconMap: Record<NodeType, NodeIconSet> = {
  ...
  TABLE: {
    ...
    lucide: "Table",
    svgPath:
      "M3 3h18v18H3V3zm2 2v4h14V5H5zm14 6H5v2h14v-2zm0 4H5v2h14v-2zm0 4H5v2h14v-2z",
  ...
  FORM: {
    ...
    lucide: "FileText",
    svgPath:
      "M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8l-6-6zm0 2l6 6h-6V4zm-2 12H8v-2h4v2zm4-4H8v-2h8v2z",
...
export const categoryColorPalette: CategoryColor[] = [
  ...
  },
  {
    ...
    secondary: "#7e57c2",
    text: "#ffffff",
    className: "category-deep-purple",
  },
  {
    primary: "#c2185b",
    secondary: "#ec407a",
  ...
  },
  {
    ...
    secondary: "#8d6e63",
    text: "#ffffff",
    className: "category-brown",
  },
  {
    primary: "#455a64",
    secondary: "#78909c",
    text: "#ffffff",
    className: "category-blue-grey",
  },
];
...
export function getNodeIcon(
  type: NodeType,
  iconSet: "emoji" | "material" | "lucide" | "svgPath" = "emoji",
): string {
  ...
  return (
    icon?.[iconSet as "emoji" | "material" | "lucide"] || icon?.emoji || "❓"
  );
}
 ...
 */
export function simplifyHealthStatus(
...
export function getHealthColors(
  status: HealthStatus | HealthLevel,
): HealthColorSet {
  const level: HealthLevel =
    typeof status === "string" ? simplifyHealthStatus(status) : status;
...
export function getSearchFilterLabel(
  ...
  return (
    (label?.[language as keyof I18nLabel] as string) ||
    label?.de ||
    String(filter)
  );
}
 ...
 */
export function getViewModeLabel(
  mode: ViewMode,
  language: string = "de",
): string {
 ...
 */
export function getHealthStatusClass(
  status: HealthStatus | HealthLevel,
): string {
  const level =
    typeof status === "string" ? simplifyHealthStatus(status) : status;
