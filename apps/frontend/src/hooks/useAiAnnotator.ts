...
// apps/frontend/src/hooks/useAiAnnotator.ts
...
export type NodeForAnnotation = {
  ...
  aa_json?: Record<string, unknown> | null;
...
// Hook-Konfiguration
interface UseAiAnnotatorOptions {
  baseUrl?: string;
}

export default function useAiAnnotator({
  baseUrl = "/api/ai-annotator",
}: UseAiAnnotatorOptions = {}) {
  ...
  // Validation state (reserved for future use)
...
export type UseAiAnnotatorReturn = ReturnType<typeof useAiAnnotator>;
