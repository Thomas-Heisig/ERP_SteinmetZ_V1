...
interface NodeSchema {
  fields?: Array<{ required?: boolean; validation?: unknown }>;
}
...
export class QualityAssuranceService {
  ...
  calculateQualityMetrics(node: Node): QualityMetrics {
    const meta = (node.meta_json || {}) as NodeMetadata;
    const schema = (node.schema_json || {}) as NodeSchema;
