...
-- Migration: RBAC System Setup
-- Description: RBAC (Role-Based Access Control) System Tables and Initial Data
-- Database: SQLite
-- Created: 2025-12-20
-- vscode-language: sqlite
...
CREATE TABLE IF NOT EXISTS user_roles (
    ...
    assigned_by TEXT,
    expires_at TEXT,  -- Optional: temporary role assignments
    is_active INTEGER DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS permissions (
    id TEXT PRIMARY KEY,
    permission TEXT UNIQUE NOT NULL,  -- Format: "module:action"
...
CREATE TABLE IF NOT EXISTS rbac_audit_log (
    id TEXT PRIMARY KEY,
    action TEXT NOT NULL,  -- role_created, role_updated, role_deleted, permission_granted, permission_revoked, role_assigned, role_revoked
...
INSERT OR IGNORE INTO permissions (id, permission, module, action, description, created_at) VALUES ('perm_dashboard_read', 'dashboard:read', 'dashboard', 'read', 'View dashboard', CURRENT_TIMESTAMP);

INSERT OR IGNORE INTO permissions (id, permission, module, action, description, created_at) VALUES
('perm_dashboard_export', 'dashboard:export', 'dashboard', 'export', 'Export dashboard data', CURRENT_TIMESTAMP);

INSERT OR IGNORE INTO permissions (id, permission, module, action, description, created_at) VALUES ('perm_user_mgmt_create', 'user_management:create', 'user_management', 'create', 'Create new users', CURRENT_TIMESTAMP);

INSERT OR IGNORE INTO permissions (id, permission, module, action, description, created_at) VALUES
('perm_user_mgmt_read', 'user_management:read', 'user_management', 'read', 'View user information', CURRENT_TIMESTAMP);

INSERT OR IGNORE INTO permissions (id, permission, module, action, description, created_at) VALUES ('perm_user_mgmt_update', 'user_management:update', 'user_management', 'update', 'Update user information', CURRENT_TIMESTAMP);

INSERT OR IGNORE INTO permissions (id, permission, module, action, description, created_at) VALUES ('perm_user_mgmt_delete', 'user_management:delete', 'user_management', 'delete', 'Delete users', CURRENT_TIMESTAMP);

INSERT OR IGNORE INTO permissions (id, permission, module, action, description, created_at) VALUES ('perm_role_mgmt_create', 'role_management:create', 'role_management', 'create', 'Create new roles', CURRENT_TIMESTAMP);

INSERT OR IGNORE INTO permissions (id, permission, module, action, description, created_at) VALUES ('perm_role_mgmt_read', 'role_management:read', 'role_management', 'read', 'View roles', CURRENT_TIMESTAMP);

INSERT OR IGNORE INTO permissions (id, permission, module, action, description, created_at) VALUES ('perm_role_mgmt_update', 'role_management:update', 'role_management', 'update', 'Update roles', CURRENT_TIMESTAMP);

INSERT OR IGNORE INTO permissions (id, permission, module, action, description, created_at) VALUES ('perm_role_mgmt_delete', 'role_management:delete', 'role_management', 'delete', 'Delete roles', CURRENT_TIMESTAMP);

INSERT OR IGNORE INTO permissions (id, permission, module, action, description, created_at) VALUES ('perm_finance_create', 'finance:create', 'finance', 'create', 'Create finance records', CURRENT_TIMESTAMP);

INSERT OR IGNORE INTO permissions (id, permission, module, action, description, created_at) VALUES ('perm_finance_read', 'finance:read', 'finance', 'read', 'View finance records', CURRENT_TIMESTAMP);

INSERT OR IGNORE INTO permissions (id, permission, module, action, description, created_at) VALUES ('perm_finance_approve', 'finance:approve', 'finance', 'approve', 'Approve finance transactions', CURRENT_TIMESTAMP);

INSERT OR IGNORE INTO permissions (id, permission, module, action, description, created_at) VALUES ('perm_hr_create', 'hr:create', 'hr', 'create', 'Create HR records', CURRENT_TIMESTAMP);

INSERT OR IGNORE INTO permissions (id, permission, module, action, description, created_at) VALUES ('perm_hr_read', 'hr:read', 'hr', 'read', 'View HR records', CURRENT_TIMESTAMP);

INSERT OR IGNORE INTO permissions (id, permission, module, action, description, created_at) VALUES ('perm_hr_approve', 'hr:approve', 'hr', 'approve', 'Approve HR requests', CURRENT_TIMESTAMP);

INSERT OR IGNORE INTO permissions (id, permission, module, action, description, created_at) VALUES ('perm_sales_create', 'sales:create', 'sales', 'create', 'Create sales records', CURRENT_TIMESTAMP);

INSERT OR IGNORE INTO permissions (id, permission, module, action, description, created_at) VALUES ('perm_sales_read', 'sales:read', 'sales', 'read', 'View sales records', CURRENT_TIMESTAMP);

INSERT OR IGNORE INTO permissions (id, permission, module, action, description, created_at) VALUES ('perm_sales_approve', 'sales:approve', 'sales', 'approve', 'Approve sales transactions', CURRENT_TIMESTAMP);

INSERT OR IGNORE INTO permissions (id, permission, module, action, description, created_at) VALUES ('perm_procurement_create', 'procurement:create', 'procurement', 'create', 'Create procurement records', CURRENT_TIMESTAMP);

INSERT OR IGNORE INTO permissions (id, permission, module, action, description, created_at) VALUES ('perm_procurement_read', 'procurement:read', 'procurement', 'read', 'View procurement records', CURRENT_TIMESTAMP);

INSERT OR IGNORE INTO permissions (id, permission, module, action, description, created_at) VALUES ('perm_procurement_approve', 'procurement:approve', 'procurement', 'approve', 'Approve procurement', CURRENT_TIMESTAMP);

INSERT OR IGNORE INTO permissions (id, permission, module, action, description, created_at) VALUES ('perm_inventory_read', 'inventory:read', 'inventory', 'read', 'View inventory', CURRENT_TIMESTAMP);

INSERT OR IGNORE INTO permissions (id, permission, module, action, description, created_at) VALUES ('perm_inventory_update', 'inventory:update', 'inventory', 'update', 'Update inventory', CURRENT_TIMESTAMP);

INSERT OR IGNORE INTO permissions (id, permission, module, action, description, created_at) VALUES ('perm_reporting_read', 'reporting:read', 'reporting', 'read', 'View reports', CURRENT_TIMESTAMP);

INSERT OR IGNORE INTO permissions (id, permission, module, action, description, created_at) VALUES ('perm_reporting_create', 'reporting:create', 'reporting', 'create', 'Create reports', CURRENT_TIMESTAMP);

INSERT OR IGNORE INTO permissions (id, permission, module, action, description, created_at) VALUES ('perm_audit_logs_read', 'audit_logs:read', 'audit_logs', 'read', 'View audit logs', CURRENT_TIMESTAMP);
