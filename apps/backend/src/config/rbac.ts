...
import { RoleNames, ModuleNames, PermissionActions, type RoleDefinition, type RoleHierarchy, type Permission } from '../types/rbac.js';

/**
 * Permission builder helper
 */
function buildPermission(module: ModuleNames | string, action: PermissionActions | string): Permission {
...
const ModulePermissions = {
  ...
  userManagement: {
    create: buildPermission(ModuleNames.USER_MANAGEMENT, PermissionActions.CREATE),
    read: buildPermission(ModuleNames.USER_MANAGEMENT, PermissionActions.READ),
    update: buildPermission(ModuleNames.USER_MANAGEMENT, PermissionActions.UPDATE),
    delete: buildPermission(ModuleNames.USER_MANAGEMENT, PermissionActions.DELETE),
    manage: buildPermission(ModuleNames.USER_MANAGEMENT, PermissionActions.MANAGE),
  },
  roleManagement: {
    create: buildPermission(ModuleNames.ROLE_MANAGEMENT, PermissionActions.CREATE),
    read: buildPermission(ModuleNames.ROLE_MANAGEMENT, PermissionActions.READ),
    update: buildPermission(ModuleNames.ROLE_MANAGEMENT, PermissionActions.UPDATE),
    delete: buildPermission(ModuleNames.ROLE_MANAGEMENT, PermissionActions.DELETE),
    manage: buildPermission(ModuleNames.ROLE_MANAGEMENT, PermissionActions.MANAGE),
  },
  finance: {
  ...
  procurement: {
    ...
    approve: buildPermission(ModuleNames.PROCUREMENT, PermissionActions.APPROVE),
  ...
  settings: {
    ...
    configure: buildPermission(ModuleNames.SETTINGS, PermissionActions.CONFIGURE),
  },
  monitoring: {
    read: buildPermission(ModuleNames.MONITORING, PermissionActions.READ),
    configure: buildPermission(ModuleNames.MONITORING, PermissionActions.CONFIGURE),
  },
  auditLogs: {
  ...
  aiAnnotator: {
    ...
    configure: buildPermission(ModuleNames.AI_ANNOTATOR, PermissionActions.CONFIGURE),
  },
  reporting: {
...
export const DEFAULT_ROLES: RoleDefinition[] = [
  ...
  },
  {
    ...
    description: 'Can manage team members and approve workflow items. Limited to specific modules.',
    is_system: true,
    is_active: true,
    permissions: [
      ModulePermissions.dashboard.read,
  ...
  },
  {
    ...
    display_name: 'Guest',
    description: 'Limited guest access. Can only access public dashboards and reports.',
    is_system: true,
    is_active: true,
    permissions: [
      ModulePermissions.dashboard.read,
